...
public class FirmwareUtils {
    ...
    Xor_Ord3_Model1 = {0xBF, 0xB7, 0x80, 0x05, 0x48, 0xDA, 0xF0, 0x77, 0xA0, 0x93, 0xE5, 0x0C, 0x07, 0x69, 0xE7, 0x2F,
    ...
    private static final int[][][] xorTables = new int[][][] {{Xor_Ord1, Xor_Ord2, Xor_Ord3},
                                                              {Xor_Ord1_Model1, Xor_Ord2_Model1, Xor_Ord3_Model1}};
    private static final int[] HEADER = {0x91, 0x87, 0x3F, 0x9A, 0x04, 0xD2, 0x25, 0xC0, 0xDC, 0x2A, 0xBD, 0xBE, 0x4B, 0xB4, 0xE5, 0x94,
...
//</editor-fold>
    ...
    public static byte[] xor(byte[] data, int index) throws IOException {
        ...
        final int [] xor1 = xorTables[index][0],
                     xor2 = xorTables[index][1],
                     xor3 = xorTables[index][2];
