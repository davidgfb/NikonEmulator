...
public class NkldUtils {
    ...
    private static final int[] tab0 = {0xc1,0xbf,0x6d,0x0d,0x59,0xc5,0x13,0x9d,0x83,0x61,0x6b,0x4f,0xc7,0x7f,0x3d,0x3d,
    ...
    private static final int[] tab1 = {0xa7,0xbc,0xc9,0xad,0x91,0xdf,0x85,0xe5,0xd4,0x78,0xd5,0x17,0x46,0x7c,0x29,0x4c,
    ...
    private static final int[] tab2 = {0x00,0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x08,0x0C,0x0C,0x0C,0x0C,0x0C,0x08,
...
//</editor-fold>
    ...
    public static final NkldHeader getNkldHeader (byte[] data) throws FirmwareFormatException {
        ...
        if ( (nkldHeader.dataOffset + nkldHeader.dataLength) > nkldHeader.totalLength || nkldHeader.totalLength>data.length) {
    ...
    protected static int getUInt16(byte[] buffer, int offset) {
        final int v0 = buffer[offset] & 0xFF,
         v1 = buffer[offset + 1] & 0xFF;
        return ((v0 << 8) | v1);
    }
    protected static int getUInt32(byte[] buffer, int offset) {
        final int v0 = buffer[offset] & 0xFF,
         v1 = buffer[offset + 1] & 0xFF,
         v2 = buffer[offset + 2] & 0xFF,
         v3 = buffer[offset + 3] & 0xFF;
